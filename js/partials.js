$(document).ready( function()
{
  ...
  $(".header").html('<a href="index.html" data-rel="back" data-theme="none"><img src="./img/button_back.png" style="position:relative;top:-2px;" /></a><center><a href="#page_home" data-theme="none"><img src="./img/logo.png" class="mini_logo" /></a></center><div class="nav_strip"><ul><center><li>Profile</li><li>Home</li><li>Search Tee Times</li></center></ul><br class="clear" /><div id="white_arrow"><center>&#9650;</center></div></div>');
